...
```{r}
# Get predicitons. To predict noisy data just add sigma_n^2*diag(ncol(xtest)) to the covariance matrix
# as implemented in the script `gp_completely_vectorized_noisy.R`.
